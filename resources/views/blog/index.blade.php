<x-frontend-layout>
    <div class="pt-32 pb-20">
        ...
        <div class="text-center mb-16 relative">
            ...
            <h1 class="font-playfair text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-4 relative">
                Nosso <span class="text-primary italic">Blog</span>
            </h1>
            <p class="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                Descubra histórias inspiradoras, dicas exclusivas e as últimas novidades do mundo do entretenimento adulto
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            @forelse ($posts as $post)
                <article class="group relative bg-white dark:bg-gray-800/50 backdrop-blur-sm rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-primary/10 hover:-translate-y-1">
                    @if ($post->image)
                    ...
                    <div class="p-8">
                        ...
                        <h2 class="text-2xl font-playfair font-bold text-gray-900 dark:text-white mb-4 group-hover:text-primary transition-colors">
